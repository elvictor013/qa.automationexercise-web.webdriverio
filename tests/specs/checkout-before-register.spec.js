...
describe('Test Case 15: Fazer pedido: Registrar-se antes do checkout', () => {

    it('deve registrar antes do checkout, fazer pedido e deletar conta', async () => {
        ...
        await AccountPage.loggedInAs.waitForDisplayed({ timeout: 10000 })
